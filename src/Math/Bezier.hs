...
bezier4 ::  Vector2 Double -> Vector2 Double -> Vector2 Double -> Vector2 Double
           -> Double
           -> Vector2 Double
...
bezierN ::  [Vector2 Double] -> Double -> Vector2 Double
...
bezierNSamples ::  Int -> [Vector2 Double] -> [Vector2 Double]
bezierNSamples 0 _  = []
